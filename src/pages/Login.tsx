  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isRegister) {
        ...
        toast({ title: "সফল!", description: "একাউন্ট তৈরি হয়েছে। Email verify করুন।" });
        setIsRegister(false);
      } else {
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        <div className="bg-card rounded-xl border border-border p-5">
          ...
          <button
            ...
            className="w-full border border-border rounded-lg h-10 flex items-center justify-center gap-2 text-[13px] font-semibold text-foreground active:bg-secondary mb-4"
          >
          ...
          <p className="text-center text-[12px] text-muted-foreground mt-4">
            {isRegister ? "Already have an account? " : "New to RG BAZZER? "}
