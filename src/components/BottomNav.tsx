        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex-1 flex flex-col items-center justify-center py-2 gap-0.5 active:bg-secondary relative ${
                isActive ? "text-primary" : "text-muted-foreground"
              }`}
            >
              {isActive && <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-[3px] bg-primary rounded-b-full" />}
