...
const Footer = () => {
  ...
  return (
    <footer className="bg-footer text-white pb-16">
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="flex gap-3 mb-8">
          <a href={fbLink} className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center active:opacity-70">
            <Facebook className="w-6 h-6 text-white" />
          </a>
          <a href="#" className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center active:opacity-70">
        ...
        <div className="space-y-3 mb-6">
          ...
          <a
            ...
            className="flex items-center gap-4 bg-white/[0.06] rounded-xl p-4 active:opacity-70"
          >
            <div className="w-11 h-11 rounded-full bg-[hsl(145,70%,40%)] flex items-center justify-center shrink-0">
              <WhatsAppIcon className="w-6 h-6 text-white" />
            </div>
            <div className="border-l border-white/20 pl-4">
              <p className="text-[13px] font-bold text-white">Help line [{hours}]</p>
          ...
          <a
            ...
            className="flex items-center gap-4 bg-white/[0.06] rounded-xl p-4 active:opacity-70"
          >
            <div className="w-11 h-11 rounded-full bg-[hsl(200,80%,50%)] flex items-center justify-center shrink-0">
